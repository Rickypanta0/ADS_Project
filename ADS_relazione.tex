...
\subsection{Caso \texorpdfstring{$\symbf{k=n/2}$}{k}}
\begin{figure}[h]
            \centering
...
\begin{figure}[h]
    \begin{subfigure}[t]{0.50\textwidth}
        \centering
        \includegraphics[width=\textwidth]{graphs/Select_increasing_n.png}
    \end{subfigure}%
    \hfill
    \begin{subfigure}[t]{0.50\textwidth}
        \centering
        \includegraphics[width=\textwidth]{graphs/Select_increasing_xlog.png}
    \end{subfigure}
    \vskip\baselineskip
    \centering
    \begin{subfigure}[t]{0.50\textwidth}
        \centering
        \includegraphics[width=\textwidth]{graphs/Select_decreasing_n.png}
    \end{subfigure}%
    \hfill
    \begin{subfigure}[t]{0.50\textwidth}
        \centering
        \includegraphics[width=\textwidth]{graphs/Select_decreasing_xlog.png}
    \end{subfigure}
...
Ma vediamo ora due casi in cui ciò può accadere: il primo in cui il vettore è ordinato in modo crescente e $k=1$ e il secondo il cui il vettore è ordinato in modo decrescente e $k=n$.\\
